...
public class MultiClickEvent {
    private static final int TIME_INTERVAL = 8000; // 8 seconds
    private static final int TIME_INTERVAL_FOR_CONFIRMATION = 3000; // 3 seconds
    private static final int PRESS_THRESHOLD = 4;  // button presses needed to activate alarm
    ...
    public void registerClick(Long eventTime) {
        if(waitForConfirmation){
            ...
            // Activates emergency protocol if pressed within time limit
